...
This R script creates a map of shelter locations in Antarctica with bathymetry data and continental outline using a Polar Stereographic projection.
...
1. **Bathymetry Processing**
   - Retrieves bathymetry data from NOAA (-180° to 180° longitude, -90° to -60° latitude)
